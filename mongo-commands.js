...
//movies with rating - execpt for 8
db.movies.find ({rating:{$ne:8}},{_id : 0,name: 1,rating:1})
//movies wuth rating - range :8.5 <9 
...
db.orders.aggregate([
 ...
 update 
 db.movies.updateMany({},{$set:{langauage: "english"}})
 db.movies.updateOne({name :"PS2"},{$set:{langauage: "Tamil"}})
